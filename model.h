...
public:
  ...
  virtual void trainSGDPar(const Data &data, Model &bestModel,
                           std::unordered_set<int> &invalidUsers,
                           std::unordered_set<int> &invalidItems) {
    std::cerr << "\n method not in base class" << std::endl;
  }
  virtual void trainSGDParSVD(const Data &data, Model &bestModel,
                              std::unordered_set<int> &invalidUsers,
                              std::unordered_set<int> &invalidItems) {
    std::cerr << "\n method not in base class" << std::endl;
  }
  virtual void trainUShuffle(const Data &data, Model &bestModel,
                             std::unordered_set<int> &invalidUsers,
                             std::unordered_set<int> &invalidItems) {
    std::cerr << "\n method not in base class" << std::endl;
  }
  ...
  virtual void trainCCDPP(const Data &data, Model &bestModel,
                          std::unordered_set<int> &invalidUsers,
                          std::unordered_set<int> &invalidItems) {
    std::cerr << "\n method not in base class" << std::endl;
  }
  virtual void trainCCDPPFreqAdap(const Data &data, Model &bestModel,
                                  std::unordered_set<int> &invalidUsers,
                                  std::unordered_set<int> &invalidItems) {
    std::cerr << "\n method not in base class" << std::endl;
  }
  virtual void trainCCD(const Data &data, Model &bestModel,
                        std::unordered_set<int> &invalidUsers,
                        std::unordered_set<int> &invalidItems) {
    std::cerr << "\n method not in base class" << std::endl;
  }
  virtual void hogTrain(const Data &data, Model &bestModel,
                        std::unordered_set<int> &invalidUsers,
                        std::unordered_set<int> &invalidItems) {
    std::cerr << "\n method not in base class" << std::endl;
  }
